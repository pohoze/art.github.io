...
// (length)
    ...
    if (!$error) {
        ...
        $subject = "Новая заявка с сайта bysany.art";
        ...
        $header .= "From: Новая заявка <bysany.design@gmail.com>\n\n";
        $mail = mail("bysany.design@gmail.com", $subject1, iconv('utf-8', 'windows-1251', $message1), iconv('utf-8', 'windows-1251', $header));
